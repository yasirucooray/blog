                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mail_section">
                            <h1 class="contact_taital">Edit Blog Post</h1>
                            <form action="{{ $post->id }}/update" method="POST">
                                {{ method_field('put') }}
                                @csrf
                                <input type="" class="email_text" placeholder="Title" name="Name" value="{{ $post->title }}">
                                <textarea class="massage_text" placeholder="Message" rows="5" id="comment" name="Message">{{ $post->content }}</textarea>
