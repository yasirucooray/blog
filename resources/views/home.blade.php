...
<body>
  ...
  <center>  <div class="about_section layout_padding" style="margin-bottom: 10%;">
        @foreach ($posts as $post)
            <div class="col-lg-8 col-sm-12" style="background-color: lightgoldenrodyellow;text-align:left;">
